...
public class MysteryBoxTemplate : ItemTemplate
{
	public new class Factory : Template.Factory
	{
		public override Template Create(MessageReader reader)
		{
			return new MysteryBoxTemplate(reader);
		}
	}

	private const int TYPE_ID = 30;
