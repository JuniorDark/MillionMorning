...
public class FoundCoinTokensInfo
{
	...
	public FoundCoinTokensInfo(MessageReader reader)
	{
	...
	public FoundCoinTokensInfo(string level, sbyte tokensAmount, int tokensFound)
	{
		_level = level;
