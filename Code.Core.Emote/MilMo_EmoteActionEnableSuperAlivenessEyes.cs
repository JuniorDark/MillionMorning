...
public sealed class MilMo_EmoteActionEnableSuperAlivenessEyes : MilMo_EmoteAction
{
	...
	{
		manager.EnableEyeLook();
	}

	public override MilMo_EmoteAction Instantiate()
	{
		return new MilMo_EmoteActionEnableSuperAlivenessEyes();
	}
}
