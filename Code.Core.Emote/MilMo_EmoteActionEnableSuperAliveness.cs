...
public sealed class MilMo_EmoteActionEnableSuperAliveness : MilMo_EmoteAction
{
	...
	{
		manager.EnableSuperAliveness();
	}

	public override MilMo_EmoteAction Instantiate()
	{
		return new MilMo_EmoteActionEnableSuperAliveness();
	}
}
