...
public sealed class MilMo_EmoteActionDisableSuperAliveness : MilMo_EmoteAction
{
	...
	{
		manager.DisableSuperAliveness();
	}

	public override MilMo_EmoteAction Instantiate()
	{
		return new MilMo_EmoteActionDisableSuperAliveness();
	}
}
