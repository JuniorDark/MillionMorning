...
public sealed class MilMo_EmoteActionDisableSuperAlivenessEyes : MilMo_EmoteAction
{
	...
	{
		manager.DisableEyeLook();
	}

	public override MilMo_EmoteAction Instantiate()
	{
		return new MilMo_EmoteActionDisableSuperAlivenessEyes();
	}
}
