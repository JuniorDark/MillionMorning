...
public class MilMo_InvertedCylinder : MilMo_Volume
{
	private MilMo_InvertedCylinderTemplate Template => VolumeTemplate as MilMo_InvertedCylinderTemplate;

	public MilMo_InvertedCylinder(MilMo_VolumeTemplate template, Transform transform)
