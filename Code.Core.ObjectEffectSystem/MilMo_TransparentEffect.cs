...
internal class MilMo_TransparentEffect : MilMo_ObjectEffect
{
	private float _time;
	...
	private MilMo_TransparentEffectTemplate Template => EffectTemplate as MilMo_TransparentEffectTemplate;

	public override float Duration => Template.Duration;

	public MilMo_TransparentEffect(GameObject gameObject, MilMo_TransparentEffectTemplate template)
