...
public class ServerDeactivatePlayerState : IMessage
{
	public class Factory : IMessageFactory
	{
		...
		{
			return new ServerDeactivatePlayerState(reader);
		}
	...
	private ServerDeactivatePlayerState(MessageReader reader)
	{
	...
	public ServerDeactivatePlayerState(string playerId, TemplateReference stateTemplate, ExposedVariableUpdate variableUpdate)
	{
