...
public class ServerMoveHomeEquipment : IMessage
{
	public class Factory : IMessageFactory
	{
		...
		{
			return new ServerMoveHomeEquipment(reader);
		}
	...
	private ServerMoveHomeEquipment(MessageReader reader)
	{
		id = reader.ReadInt64();
	...
	public ServerMoveHomeEquipment(long id, string gridCell, float rotation, sbyte inStorage, long inRoom)
	{
		this.id = id;
